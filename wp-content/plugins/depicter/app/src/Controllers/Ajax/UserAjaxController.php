...
class UserAjaxController {
	...
	public function register( RequestInterface $request, $view ) {
		...
		$fields = [
			'first_name' => Sanitize::textfield( $request->body('firstName', '') ),
			'last_name'  => Sanitize::textfield( $request->body('lastName', '') ),
			'billing_first_name' => Sanitize::textfield( $request->body('firstName', '') ),
			'billing_last_name'  => Sanitize::textfield( $request->body('lastName', '') )
		];
