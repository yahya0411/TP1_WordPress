...
class DashboardPage
{
	...
	public function renewTokens() {
		if ( false === \Depicter::cache('base')->get( 'members_access_token' ) ) {
			UserAPIService::renewAccessToken();
		}

		if ( false === \Depicter::cache('base')->get( 'members_refresh_token' ) ) {
			UserAPIService::renewRefreshToken();
		}
	}
