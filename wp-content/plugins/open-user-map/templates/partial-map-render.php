...
if ( $oum_custom_js ) {
    ?>
          ...
          <?php 
    $oum_custom_script_text = "window.addEventListener('load', () => {\n        \n            " . $oum_custom_js . "\n        \n          })";
    ?>

          custom_oum_script = document.createElement('script');
          custom_oum_script.text = `<?php 
    echo  $oum_custom_script_text ;
    ?>`;

          document.body.appendChild(custom_oum_script);
